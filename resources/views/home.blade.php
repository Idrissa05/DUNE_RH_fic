           ...
           <div class="row">
               <div class="col-md-4">
                   <div class="card text-center">
                       <div class="card-header bg-success text-white"><i class="mdi mdi-account-multiple-outline mdi-36px"></i></div>
                       <div class="card-body">
                           <p>
                               Liste des agents probables retraités de l’année en cours.
                           </p>
                           <a href="{{ route('prints.retraitables') }}" title="imprimer" class="btn btn-sm btn-red"><i class="mdi mdi-printer mdi-18px"></i> Imprimer</a>
                       </div>
                   </div>
               </div>
               <div class="col-md-8">
                   <div class="card text-center">
                       ...
                       <div class="card-body">
                           ...
                           <form action="{{ route('prints.list') }}" class="form-inline align-items-end">
               ...
               <div class="col-md-4">
                   <div class="card text-center">
                       ...
                       <div class="card-body">
                           ...
                           <form action="{{ route('prints.parcorps') }}" class="form-inline align-items-end">
               ...
               <div class="col-md-4">
                   <div class="card text-center">
                       ...
                       <div class="card-body">
                           ...
                           <form action="{{ route('prints.parposition') }}" class="form-inline align-items-end">
               ...
               <div class="col-md-4">
                   <div class="card text-center">
                       ...
                       <div class="card-body">
                           ...
                           <form action="{{ route('prints.parmatrimoniale') }}" class="form-inline align-items-end">
               ...
               <div class="col-md-5">
                   <div class="card text-center">
                       ...
                       <div class="card-body">
                           ...
                           <form action="{{ route('prints.infos') }}" class="form-inline align-items-end">
                               <select name="agent" class="form-control form-control-sm mr-1">
